...
h=client.write_contract(address=address,function_name='submit_witness_package',args=[pid,'Build and transfer an open public sensor network to six neighbourhood councils.',['Six sensor locations are publicly documented','Public readings remain openly accessible','Operational custody is accepted by every council'],'Deploy community sensor mesh',['https://www.who.int/publications/i/item/9789240090259'],42000]);accepted(client,h)
